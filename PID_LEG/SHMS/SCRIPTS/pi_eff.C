...
void pi_eff(int RunNumber=0){
  ...
  Long64_t nentries = t->GetEntries();
    ...
    //       hPcal_E_p_shlo->Fill(etottracknorm);}
       ...
       leg7->Draw();
       leg8->Draw();
       c1->SaveAs(Form("PID_LEG/SHMS/SHMS_%d_Total_E_p_with_PID_LEGS_PIONS.pdf",RunNumber));
       ...
       leg15->Draw();
       leg16->Draw();
       c2->SaveAs(Form("PID_LEG/SHMS/SHMS_%d_PreSh_E_p_with_PID_LEGS_PIONS.pdf",RunNumber));
       ...
       leg17->Draw();
       leg18->Draw();
       c3->SaveAs(Form("PID_LEG/SHMS/SHMS_%d_NGCER_npe_with_PID_LEGS_PIONS.pdf",RunNumber));
       ...
       leg26->Draw();
       c4->SaveAs(Form("PID_LEG/SHMS/SHMS_%d_PreSh_vs_Total_E_p_with_PID_LEGS_PIONS.pdf",RunNumber));
       ...
       leg27->Draw();
       leg28->Draw();
       c5->SaveAs("SHMS_NGCER_PulseAmp_with_PID_LEGS_PIONS.pdf");
       ...
       leg30->Draw();
       leg31->Draw();
       c6->SaveAs("SHMS_PreSh_PulseAmp_with_PID_LEGS_PIONS.pdf");
*/
}
