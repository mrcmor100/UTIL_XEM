...
void el_pid_leg(int RunNumber=0){
  ...
  Long64_t nentries = t->GetEntries();
    ...
    //       hPcal_E_p_shlo->Fill(etottracknorm);}
       ...
       leg7->Draw();
       leg8->Draw();
       c1->SaveAs(Form("PID_LEG/SHMS/SHMS_%d_Total_E_p_with_PID_LEGS_ELECTRONS.pdf",RunNumber));

       TCanvas *c2 = new TCanvas("c2", "c2", 1600, 1200);
       gPad->SetLogy();
       TLegend *leg9 = new TLegend(0.6,0.6,.8,0.95);
       leg9->SetFillStyle(0);
       leg9->SetTextSize(0.045);
       leg9->SetBorderSize(0);
       leg9->SetFillColor(-1);
       leg9->SetTextColor(kBlack);
       leg9->AddEntry(hPpre_E_p,"3/4-ELECTRONS","");
       TLegend *leg10 = new TLegend(0.6,0.55,.8,0.9);
       ...
       TLegend *leg11 = new TLegend(0.6,0.5,.8,0.85);
       ...
       TLegend *leg12 = new TLegend(0.6,0.45,.8,0.8);
       ...
       TLegend *leg13= new TLegend(0.6,0.4,.8,0.75);
       ...
       TLegend *leg14 = new TLegend(0.6,0.35,.8,0.7);
       ...
       TLegend *leg15 = new TLegend(0.6,0.3,.8,0.65);
       ...
       TLegend *leg16 = new TLegend(0.6,0.25,.8,0.6);
       ...
       leg15->Draw();
       leg16->Draw();
       c2->SaveAs(Form("PID_LEG/SHMS/SHMS_%d_PreSh_E_p_with_PID_LEGS_ELECTRONS.pdf",RunNumber));


       TCanvas *c3 = new TCanvas("c3", "c3", 1600, 1200);
       gPad->SetLogy();
       TLegend *leg17 = new TLegend(0.6,0.6,.8,0.95);
       leg17->SetFillStyle(0);
       leg17->SetTextSize(0.045);
       leg17->SetBorderSize(0);
       leg17->SetFillColor(-1);
       leg17->SetTextColor(kMagenta);
       leg17->AddEntry(hPngcer,"3/4-ELECTRONS","");
       hPngcer->SetStats(0);
       hPngcer->Draw("hist");
       TLegend *leg18 = new TLegend(0.6,0.55,.8,0.9);
       ...
       leg17->Draw();
       leg18->Draw();
       c3->SaveAs(Form("PID_LEG/SHMS/SHMS_%d_NGCER_npe_with_PID_LEGS_ELECTRONS.pdf",RunNumber));
       ...
       leg19->AddEntry(hPpre_vs_cal,"3/4-ELECTRONS","");
       ...
       leg26->Draw();
       c4->SaveAs(Form("PID_LEG/SHMS/SHMS_%d_PreSh_vs_Total_E_p_with_PID_LEGS_ELECTRONS.pdf",RunNumber));
       ...
       leg27->Draw();
       leg28->Draw();
       c5->SaveAs("SHMS_NGCER_PulseAmp_with_PID_LEGS_ELECTRONS.pdf");
       ...
       leg30->Draw();
       leg31->Draw();
       c6->SaveAs("SHMS_PreSh_PulseAmp_with_PID_LEGS_ELECTRONS.pdf");
*/
}
