...
void pid_leg_presh(int RunNumber=0){
   if (RunNumber == 0){
  ...
  Long64_t nentries = t->GetEntries();
    ...
    //       hPcal_E_p_shlo->Fill(etottracknorm);}
       ...
       leg1->AddEntry(hPpre_E_p,"3/4-ALL","");
       ...
       leg2->AddEntry(hPpre_E_p_elreal,"ELREAL","");
       ...
       leg3->AddEntry(hPpre_E_p,"3/4-ALL","");
       ...
       leg4->AddEntry(hPpre_E_p_elclean,"ELCLEAN","");
       hPpre_E_p->SetStats(0);
       hPpre_E_p->Draw("hist");
       ...
       leg5->AddEntry(hPpre_E_p,"3/4-ALL","");
       ...
       leg6->AddEntry(hPpre_E_p_ello,"ELLO","");
       hPpre_E_p->SetStats(0);
       hPpre_E_p->Draw("hist");
       ...
       leg7->AddEntry(hPpre_E_p,"3/4-ALL","");
       ...
       leg->AddEntry(hPpre_E_p_prlo,"PRLO","");
       hPpre_E_p->SetStats(0);
       hPpre_E_p->Draw("hist");
       ...
       leg11->AddEntry(hPpre_E_p_prhi,"PRHI","");
       hPpre_E_p->SetStats(0);
       hPpre_E_p->Draw("hist");
       ...
       leg12->AddEntry(hPpre_E_p,"3/4-ALL","");
       ...
       leg13->AddEntry(hPpre_E_p_cer,"CER","");
       hPpre_E_p->Draw("hist same");
