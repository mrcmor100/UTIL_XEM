...
void pid_leg(int RunNumber=0){
  ...
  Long64_t nentries = t->GetEntries();
    ...
    for (Long64_t i=0; i<nentries; i++){
       ...
       leg8->Draw();
       leg9->Draw();
       c1->SaveAs(Form("PLOTS/HMS/HMS_%d_Total_E_p_with_PID_LEGS.pdf",RunNumber));
       ...
       leg17->Draw();
       leg18->Draw();
       c2->SaveAs(Form("PLOTS/HMS/HMS_%d_PreSh_E_p_with_PID_LEGS.pdf",RunNumber));
       ...
       leg19->Draw();
       leg20->Draw();
       c3->SaveAs(Form("PLOTS/HMS/HMS_%d_CER_npe_with_PID_LEGS.pdf",RunNumber));
       ...
       leg29->Draw();
       c4->SaveAs(Form("PLOTS/HMS/HMS_%d_PreSh_vs_Total_E_p_with_PID_LEGS.pdf",RunNumber));
       ...
       leg30->Draw();
       leg31->Draw();
       c5->SaveAs(Form("PLOTS/HMS/HMS_%d_CER_PulseAmp_with_PID_LEGS.pdf",RunNumber));
       ...
       leg33->Draw();
       leg34->Draw();
       c6->SaveAs(Form("PLOTS/HMS/HMS_%d_PreSh_PulseAmp_with_PID_LEGS.pdf",RunNumber));
       ...
       leg38->Draw();
       c7->SaveAs(Form("PLOTS/HMS/HMS_%d_PreSh_PulseAmp_vs_Total_E_p_with_PID_LEGS.pdf",RunNumber));
       ...
       leg35->Draw();
       leg39->Draw();
       c8->SaveAs(Form("PLOTS/HMS/HMS_%d_Sh_PulseAmp_with_PID_LEGS.pdf",RunNumber));
       ...
       leg41->Draw();
       c9->SaveAs(Form("PLOTS/HMS/HMS_%d_Sh_PulseAmp_vs_Total_E_p_with_PID_LEGS.pdf",RunNumber));
}
