...
void pi_pid_leg(int RunNumber=0){
  ...
  Long64_t nentries = t->GetEntries();
    ...
    for (Long64_t i=0; i<nentries; i++){
       ...
       leg8->Draw();
       leg9->Draw();
       c1->SaveAs(Form("PLOTS/HMS/HMS_%d_Total_E_p_with_PID_LEGS_PIONS.pdf",RunNumber));
       ...
       leg17->Draw();
       leg18->Draw();
       c2->SaveAs(Form("PLOTS/HMS/HMS_%d_PreSh_E_p_with_PID_LEGS_PIONS.pdf",RunNumber));
       ...
       leg19->Draw();
       leg20->Draw();
       c3->SaveAs(Form("PLOTS/HMS/HMS_%d_NGCER_npe_with_PID_LEGS_PIONS.pdf",RunNumber));
       ...
       leg29->Draw();
       c4->SaveAs(Form("PLOTS/HMS/HMS_%d_PreSh_vs_Total_E_p_with_PID_LEGS_PIONS.pdf",RunNumber));
