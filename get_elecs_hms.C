...
void get_elecs_hms(Int_t run_num, Double_t elec_goal){  

  Double_t shtrk, npe, delta;
  
  string myfile; 
  myfile = Form("/net/cdaqfs/home/cdaq/hallc-online/hallc_replay/ROOTfiles/hms_replay_production_%d_100000.root",run_num);
